...
class AutoImportTest(unittest.TestCase):
    ...
    def test_get_names(self):
        self.mod1.write("myvar = None\n")
        self.importer.update_resource(self.mod1)
        self.assertEqual(["mod1"], self.importer.get_names("myvar"))

    def test_get_names_inside_packages(self):
        self.mod1.write("myvar = None\n")
        self.mod2.write("myvar = None\n")
        self.importer.update_resource(self.mod1)
        self.importer.update_resource(self.mod2)
        self.assertEqual(
            set(["mod1", "pkg.mod2"]), set(self.importer.get_names("myvar"))
        )
    ...
    def test_empty_cache(self):
        ...
        self.assertEqual([], self.importer.get_names("myvar"))
    ...
    def test_not_caching_underlined_names(self):
        ...
        self.assertEqual([], self.importer.get_names("_myvar"))
        self.importer.update_resource(self.mod1, underlined=True)
        self.assertEqual(["mod1"], self.importer.get_names("_myvar"))
    ...
    def test_caching_underlined_names_passing_to_the_constructor(self):
        ...
        self.assertEqual(["mod1"], importer.get_names("_myvar"))
    ...
    def test_handling_builtin_modules(self):
        ...
        self.assertTrue("sys" in self.importer.get_names("exit"))
...
class AutoImportObservingTest(unittest.TestCase):
    ...
    def test_moving_files(self):
        ...
        self.assertEqual(["mod3"], self.importer.get_names("myvar"))
