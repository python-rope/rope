...
class TestAutoImport:
    ...
    def test_update_resource(self, importer, mod1):
        ...
        assert [("myvar", f"mod1")] == importer.import_assist("myva")
    ...
    def test_get_modules(self, mod1, importer):
        mod1.write("myvar = None\n")
        importer.update_resource(mod1)
        assert ["mod1"] == importer.get_modules("myvar")

    def test_get_modules_inside_packages(self, mod1, mod2, importer):
        mod1.write("myvar = None\n")
    ...
    def test_empty_cache(self, importer, mod1):
        mod1.write("myvar = None\n")
        importer.update_resource(mod1)
        assert ["mod1"] == importer.get_modules("myvar")
...
class TestAutoImportObserving:
    def test_writing_files(self, importer_observing, mod1):
        mod1.write("myvar = None\n")
        assert ["mod1"] == importer_observing.get_modules("myvar")

    def test_moving_files(self, importer_observing, mod1):
        mod1.write("myvar = None\n")
        mod1.move("mod3.py")
        assert ["mod3"] == importer_observing.get_modules("myvar")
